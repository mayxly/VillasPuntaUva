...
export const messages = {
  en: {
    ...
    common: { arrival: 'Arrival Date', departure: 'Departure Date', checkIn: 'Check-in', checkout: 'Checkout', guests: 'Guests', selectDate: 'Select date', guest: 'Guest', viewSuites: 'View Suites', reserve: 'Reserve', from: 'from', night: 'night', nights: 'nights', showMore: 'Show more', showLess: 'Show less', close: 'Close', previous: 'Previous', next: 'Next', kid: 'Kid', kids: 'Kids', kidsUnder5: 'Children under 5', kidsUnder5Note: 'Free, does not count as a guest', pet: 'Pet', pets: 'Pets', petsNote: '$10/night per pet', done: 'Done' },
    booking: { modalTitle: 'Ready to book?', modalText: 'Text or WhatsApp us at {{phone}} to book your stay, ask a question, or inquire about availability.', message: 'Message {{phone}}', estimate: 'Estimate your stay', checkoutAfterArrival: 'Please choose a checkout date after your arrival date.', minNightsNote: '{{count}}-night minimum', minNightsError: 'This villa requires a {{count}}-night minimum stay.', selectGuest: 'Please select at least one guest.', selectArrival: 'Please select an arrival date.', selectDeparture: 'Please select a departure date.', selectDates: 'Select your dates to see an estimated stay total.', nightlySubtotal: 'Nightly subtotal for {{count}} {{unit}}', weeklyDiscount: 'Weekly discount (10%)', lastMinuteDiscount: 'Last-minute discount (10%)', extraGuestFee: 'Extra guest fee ({{count}})', petFee: 'Pet fee ({{count}})', cleaningFee: 'Cleaning fee', estimatedTotal: 'Estimated total' },
  ...
  es: {
    ...
    booking: { modalTitle: '¿Listo para reservar?', modalText: 'Envíenos un mensaje de texto o WhatsApp al {{phone}} para reservar su estadía, hacer una pregunta o consultar disponibilidad.', message: 'Enviar mensaje al {{phone}}', estimate: 'Calcule su estadía', checkoutAfterArrival: 'Seleccione una fecha de salida posterior a la llegada.', minNightsNote: 'Mínimo {{count}} noches', minNightsError: 'Esta villa requiere una estadía mínima de {{count}} noches.', selectGuest: 'Seleccione al menos un huésped.', selectArrival: 'Seleccione una fecha de llegada.', selectDeparture: 'Seleccione una fecha de salida.', selectDates: 'Seleccione sus fechas para ver un total estimado de la estadía.', nightlySubtotal: 'Subtotal de {{count}} {{unit}}', weeklyDiscount: 'Descuento semanal (10%)', lastMinuteDiscount: 'Descuento de última hora (10%)', extraGuestFee: 'Cargo por huésped adicional ({{count}})', petFee: 'Cargo por mascota ({{count}})', cleaningFee: 'Tarifa de limpieza', estimatedTotal: 'Total estimado' },
    ...
    suites: { title: 'Villas', hero: 'Descubra villas privadas para mañanas tranquilas, tardes con brisa salina y estadías caribeñas sin esfuerzo.', listings: 'Listado de villas', showingAll: 'Mostrando todas las villas disponibles', showingFor: 'Mostrando villas disponibles para {{count}} {{unit}}', clear: 'Limpiar búsqueda', noMatch: 'No hay villas que coincidan con su búsqueda', smallerGroup: 'Pruebe con un grupo más pequeño para ver más villas.', allSuites: 'Ver todas las villas', viewDetails: 'Ver detalles', sleeps: 'Capacidad para {{count}}', all: 'Todas las villas', special: 'Lo que la hace especial', sleep: 'Dónde dormirá', offers: 'Lo que ofrece este lugar', moreAmenities: 'Mostrar más comodidades', lessAmenities: 'Mostrar menos comodidades', goodToKnow: 'Información importante', rates: 'Tarifas 2026', rateHigh: 'Tarifas de temporada alta', rateLow: 'Tarifas de temporada baja', weekdays: 'entre semana', weekends: 'fin de semana', fees: 'Tarifas y descuentos', discount: '10% de descuento en estadías de 7 noches o más, o reservas hechas dentro de los 7 días previos a la llegada', extraGuestFeeNote: '{{amount}}/noche por huésped adicional a la capacidad base', directBook: 'Reserve directamente con nosotros para evitar cargos de plataformas externas y obtener la mejor experiencia de reserva directa.', alsoSeen: 'También disponible en', notFound: 'Villa no encontrada', missing: 'La villa que busca no existe.', back: 'Volver a las villas', photoGallery: 'Galería de fotos', morePhotos: 'Ver más', closeGallery: 'Cerrar galería de fotos', twoNightMinimum: 'Las siguientes villas están disponibles pero requieren una estadía mínima de dos noches', twoNightMinimumException: 'Se pueden hacer excepciones, contáctenos por WhatsApp al +506 6145 9916' },
