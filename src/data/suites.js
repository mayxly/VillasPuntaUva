...
export const suites = [
  {
    ...
    amenities: [
      ...
      },
      {
        ...
        items: ['Washer and dryer in unit', 'Free laundry for stays of 5 nights or more', '₡4,500/night laundry fee for the whole reservation on stays under 5 nights', 'Essentials', 'Bed linens', 'Cotton linens', 'Extra pillows and blankets', 'Room-darkening shades', 'Iron', 'Safe', 'Wardrobe storage'],
      },
      {
  ...
  },
  {
    ...
    amenities: [
      ...
      {
        title: 'Bedroom and laundry',
        items: ['Washer and dryer in unit', 'Free laundry for stays of 5 nights or more', '₡4,500/night laundry fee for the whole reservation on stays under 5 nights', 'Essentials', 'Hangers', 'Bed linens', 'Extra pillows and blankets', 'Room-darkening shades', 'Iron', 'Safe', 'Clothing storage'],
      },
      {
        title: 'Kitchen and dining',
  ...
  },
  {
    ...
    amenities: [
      ...
      {
        title: 'Bedroom and laundry',
        items: ['Washer and dryer in unit', 'Free laundry for stays of 5 nights or more', '₡4,500/night laundry fee for the whole reservation on stays under 5 nights', 'Essentials', 'Hangers', 'Bed linens', 'Cotton linens', 'Extra pillows and blankets', 'Room-darkening shades', 'Iron', 'Safe', 'Clothing storage'],
      },
      {
        title: 'Kitchen and dining',
  ...
  },
  {
    ...
    amenities: [
      ...
      {
        title: 'Bedroom and laundry',
        items: ['Washer and dryer in unit', 'Free laundry for stays of 5 nights or more', '₡4,500/night laundry fee for the whole reservation on stays under 5 nights', 'Bed linens', 'Cotton linens', 'Safe', 'Dresser storage'],
      },
      {
        title: 'Kitchen and dining',
